 ...
 */
declare namespace com.zhekasmirnov.innercore.mod.build.BuildConfig {
	class ResourceDir {
		path: string;
		resourceType: string;
	}
}
declare namespace com.zhekasmirnov.innercore.mod.build {
	class Mod {
		dir: string;
		buildConfig: BuildConfig;
	}
	class BuildConfig {
		resourceDirs: java.util.ArrayList<com.zhekasmirnov.innercore.mod.build.BuildConfig.ResourceDir>;
	}
}

declare var __mod__: com.zhekasmirnov.innercore.mod.build.Mod;
