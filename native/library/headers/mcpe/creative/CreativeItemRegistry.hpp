...
static_assert(offsetof(ActorDefinitionIdentifier) == 20, "CreativeItemRegistry groups position");
static_assert(offsetof(ActorDefinitionIdentifier) == 32, "CreativeItemRegistry categories position");
